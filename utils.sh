...
APP_NAME="${APP_NAME:-Voidium Code}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-bouclem/Voidium-Code}"
BINARY_NAME="${BINARY_NAME:-voidium}"
GH_REPO_PATH="${GH_REPO_PATH:-bouclem/Voidium-Code}"
ORG_NAME="${ORG_NAME:-Voidware}"
