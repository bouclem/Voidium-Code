    ...
    private registerCommands(context: vscode.ExtensionContext): void {
        ...
        context.subscriptions.push(
            vscode.commands.registerCommand('voidium.resetWelcome', async () => {
                ...
                vscode.window.showInformationMessage('Voidium Code Insiders: Welcome popup will show on next startup.');
            })
        );
    }

    private async showWelcome(context: vscode.ExtensionContext): Promise<void> {
        const message = 'Welcome to Voidium Code Insiders! Get early access to new features with cyan-accented theme and pre-release updates. Thanks for testing!';
